...
const Response = __webpack_require__(176);
...
const unzip = __webpack_require__(178).unzip;
const extend = __webpack_require__(179);
...
const RequestBase = __webpack_require__(185);
...
exports.agent = __webpack_require__(187);
...
var _ESE_STATUS_MAP = __webpack_require__(202);
  ...
  (0, _createClass3.default)(Job, [{
    ...
    value: function info() {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        .set(_this3._server.headers).end(function (err, res) {
          if (res && res.ok) {
    ...
    value: function cancel(force) {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        .set(_this4._server.headers).end(function (err, res) {
          if (res && res.ok) {
            resolve(true);
          } else {
            var status = err && err.status ? ': ' + err.status : '';
...
var Server = function (_EventEmitter) {
  ...
  function Server(serverArgs) {
     ...
     * @type {Object}
     */
    _this.headers = serverArgs.headers || {};
...
var populate = __webpack_require__(175);
...
module.exports =
{
  ...
  serial        : __webpack_require__(174),
...
const util = __webpack_require__(3);
const Stream = __webpack_require__(15);
const ResponseBase = __webpack_require__(177);
...
mime.define(__webpack_require__(181));
...
const AgentBase = __webpack_require__(188);
let methods = __webpack_require__(87);
...
exports['application/x-www-form-urlencoded'] = __webpack_require__(190);
exports['application/json'] = __webpack_require__(191);
exports.text = __webpack_require__(192);

const binary = __webpack_require__(193);
  ...
  (0, _createClass3.default)(Service, [{
    ...
    value: function info() {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        request.get(url).use(nocache) // Prevents caching of *only* this request
        .set(_this._server.headers).end(function (err, res) {
          if (res && res.ok) {
    ...
    value: function taskInfoList() {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        .set(_this2._server.headers).end(function (err, res) {
          if (res && res.ok) {
            var tasks = [];
  ...
  (0, _createClass3.default)(Task, [{
    ...
    value: function submit(options, progressCallback, startedCallback) {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        request.post(url).set('Content-Type', 'application/json').set('GSF-noredirect', 'true').set(_this2._server.headers).send((0, _stringify2.default)(options.parameters || options)).use(nocache) // Prevents caching of *only* this request
